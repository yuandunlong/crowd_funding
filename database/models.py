...
class BaseModel(db.Model):
    ...
    created_time = db.Column('created_time', db.TIMESTAMP,server_default=func.now())
    updated_time = db.Column('updated_time', db.TIMESTAMP,server_default=func.now())
    def as_map(self):
        fields={}
...
class User(BaseModel):
    ...
    status = db.Column('status', db.Integer,default=1)  # 1 注册未激活 2激活 3 封号，4 删除
