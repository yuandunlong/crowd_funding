...
CKEDITOR.editorConfig = function( config ) {
   ...
   // config.filebrowserImageBrowseUrl = 'ckfinder/ckfinder.html?Type=Images'; //上传图片时浏览服务文件夹
    ...
    //Sconfig.filebrowserUploadUrl = 'ckfinder/core/connector/aspx/connector.aspx?command=QuickUpload&type=Files'; //上传文件按钮(标签)
    config.filebrowserImageUploadUrl = '/ckupload/?command=QuickUpload&type=Images'; //上传图片按钮(标签)
